...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupEventListeners() {
        try {
            // Class selection
            if (elements.classGrid) {
                elements.classGrid.addEventListener('click', function(e) {
            ...
            if (elements.subjectGrid) {
                elements.subjectGrid.addEventListener('click', function(e) {
                    ...
                    if (subjectCard && subjectCard.classList.contains('available')) {
                        selectSubject(subjectCard);
                    }
                });
            }

            // Level selection (will be set up when levels are loaded)
    ...
    function loadLevels() {
        try {
            ...
            for (let i = 1; i <= 5; i++) {
                ...
                const isUnlocked = i === 1 || levelsProgress[i - 2] === true; // Level is unlocked if previous level is completed
